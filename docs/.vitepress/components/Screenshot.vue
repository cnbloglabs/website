...
<template>
  <div class="flex flex-col bg-[var(--vp-c-bg-soft)] rounded w-[600px] mt-4">
    <div class="flex items-center">
      <div
        v-for="item in tabs"
        :key="item.title"
        class="py-2 px-6 cursor-pointer text-center"
        :class="{ 'bg-[var(--vp-c-bg-mute)] text-[var(--vp-c-brand)] rounded transition': item.title === currentScreenshot?.title }"
