...
<template>
  <div text-center>
    <img
      loading="lazy" :src="avatar" width="100" height="100" rounded-full min-w-25 min-h-25 h-25 w-25
      :alt="`${name}'s avatar`"
    >
    ...
    <div flex="~ inline gap-2" py-4 text-2xl>
      <a
        ...
        :href="`https://github.com/${github}`" target="_blank" rel="noopener noreferrer"
    ...
    <br>
    <a
      v-if="sponsors" class="btn mt-1 bg-pink-500 hover:bg-pink-600" target="_blank" rel="noopener noreferrer"
